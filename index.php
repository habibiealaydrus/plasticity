...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner ">
        <div class="carousel-item active">
            <img src="img/carousel/C1.jpg" class="d-block w-100" alt="karusel 1">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/C2.jpg" class="d-block w-100" alt="karusel 2">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/C3.jpg" class="d-block w-100" alt="karusel 3">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/C4.jpg" class="d-block w-100" alt="karusel 3">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/D0.jpg" class="d-block w-100" alt="karusel 3">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/D1.jpg" class="d-block w-100" alt="karusel 3">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/D2.jpg" class="d-block w-100" alt="karusel 3">
        </div>
        <div class="carousel-item">
            <img src="img/carousel/D3.jpg" class="d-block w-100" alt="karusel 3">
        </div>
    </div>
...
<div class="container-fluid text-center">
    ...
    <div class="row fade-in" style="background-color: whitesmoke;">
        <div class="col-sm-6 mt-0">
            <img src="img/image-credit2.png" class="img-fluid">
        </div>
        <div class="col-sm-6">
            <p class="text-start" style="font-size: 14px;">
                ...
                <span>
                    Matra Studio <br>
                    Rizki Tridamayanti Siregar, Yasser Hafizs, Erika Angelina, Alvioletta Geraldine<br>
                </span></br>
                <strong>Kolaborator</strong></br>
                <span>
                    UMN<br>
                    M. Cahya Mulya Daulay,S.Sn., M.Ds.,Rahmi Elsa Diana, S.T., M.T.<br>
                    Mortier<br>
                    Mendy, Irene, Retno, Jason, Gita, Michi, Sekar, Ariesta, Syifa, dan Mas Mas<br>
                    Yayasan Wings Group<br>
                </span></br>
                <strong>Tim Fabrikasi</strong></br>
                <span>
                    Chaeri Abdillah, Gema Ibrahim Ahmada, Sangkakala P. Indo, Naya Kamila, Farah Artanti, Alicia Phannely, Ayu Nabilah, Shafira Ardhani, Pramudya Abimanyu, Donny
                    Aditya Natanael, Rafa Naufal Adli, Nurul Izzah Saidah, Adetia Widiani, Helen Agustini, Theresia Winna,Christy Viani, Silvia Deborah Ulag, Wenzel Ferrel, Rapha Zakharia, Reno Alvero Soe<br>
                </span></br>
                <strong>Video Editing</strong></br>
                <span>
                    Rafiandy Bimo Nugroho, Bhagaskara Tri Atmojo<br>
                </span></br>
    ...
    <div class="row fade-in">
        <div class="d-flex justify-content-center">
            <div class="p-1">
                <img src="img/logomatrastudio.png" width="100%" class="image-fluid">
            </div>
        </div>
        <center>
            <p>
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="p-2" style="filter: drop-shadow(5px 5px 5px #222);">
    ...
    <div class="row fade-in">
        <div class="col-sm-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3966.484358366396!2d106.8206241!3d-6.1996504!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f41f043cccf9%3A0x91cf8ef9ddcaa3c5!2sThamrin%20Nine%20Tower%201!5e0!3m2!1sid!2sid!4v1694927479715!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div class="col-sm-6">
            <p class="display-6" style="text-align: left;padding:5%">
                <strong>LOCATION</strong><br>
            </p>
            <figure class="text-end">
                <blockquote class="blockquote">
                    <p>Thamrin Nine Tower 1</p>
                </blockquote>
                <figcaption class="blockquote-footer">
                    Jl. M.H. Thamrin No.8-9,<br>
                    Kb. Melati, Kecamatan Tanah Abang, Kota Jakarta Pusat,<br>
